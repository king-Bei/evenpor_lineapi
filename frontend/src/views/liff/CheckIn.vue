        ...
        <el-form :model="form" :rules="rules" ref="formRef" label-position="top">
          ...
          <el-form-item label="手機號碼" prop="phone">
            <el-input v-model="form.phone" placeholder="例如: 0912345678" size="large">
              <template #prefix><el-icon><Iphone></Iphone></el-icon></template>
            </el-input>
          </el-form-item>
          ...
          <el-form-item label="身分證字號 / 護照號碼" prop="idNumber">
            <el-input 
              ...
              show-password
            >
              <template #prefix><el-icon><Postcard></Postcard></el-icon></template>
            </el-input>
          </el-form-item>
          ...
          <el-form-item label="出生年月日" prop="birthday">
            <el-input 
              ...
              maxlength="8"
            >
              <template #prefix><el-icon><Calendar></Calendar></el-icon></template>
            </el-input>
          </el-form-item>
